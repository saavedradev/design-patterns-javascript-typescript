...
console.log(encoder2.encode('Esto es un texto. Y aqui comienza otro. Y aqui otro más'));
console.log(encoder2.decode('<p>Esto es un texto</p><p>Y aqui comienza otro</p><p>Y aqui otro más</p>'));